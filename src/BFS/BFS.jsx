...
const DUMMY_OBSTACLES = [
  '{"q":-6,"r":-9,"s":15}', '{"q":-5,"r":-9,"s":14}', '{"q":-4,"r":-9,"s":13}','{"q":-3,"r":-9,"s":12}',
  '{"q":-2,"r":-9,"s":11}', '{"q":-1,"r":-9,"s":10}', '{"q":0,"r":-9,"s":9}','{"q":1,"r":-9,"s":8}',
  '{"q":2,"r":-9,"s":7}', '{"q":3,"r":-9,"s":6}', '{"q":4,"r":-9,"s":5}','{"q":5,"r":-9,"s":4}',
  '{"q":6,"r":-9,"s":3}', '{"q":7,"r":-9,"s":2}', '{"q":8,"r":-9,"s":1}','{"q":9,"r":-9,"s":0}',
  '{"q":10,"r":-9,"s":-1}', '{"q":11,"r":-9,"s":-2}', '{"q":12,"r":-9,"s":-3}','{"q":13,"r":-9,"s":-4}',
  '{"q":14,"r":-9,"s":-5}', '{"q":15,"r":-9,"s":-6}', '{"q":-7,"r":-8,"s":15}','{"q":-7,"r":-7,"s":14}',
  '{"q":-8,"r":-6,"s":14}','{"q":-8,"r":-5,"s":13}', '{"q":-9,"r":-4,"s":13}','{"q":-9,"r":-3,"s":12}',
  '{"q":-10,"r":-2,"s":12}','{"q":-10,"r":-1,"s":11}', '{"q":-11,"r":0,"s":11}','{"q":-11,"r":1,"s":10}',
  '{"q":-12,"r":2,"s":10}','{"q":-12,"r":3,"s":9}', '{"q":-13,"r":4,"s":9}','{"q":-13,"r":5,"s":8}',
  '{"q":-14,"r":6,"s":8}','{"q":-14,"r":7,"s":7}', '{"q":-15,"r":8,"s":7}','{"q":-15,"r":9,"s":6}',
  '{"q":-14,"r":9,"s":5}','{"q":-13,"r":9,"s":4}', '{"q":-12,"r":9,"s":3}','{"q":-11,"r":9,"s":2}',
  '{"q":-10,"r":9,"s":1}','{"q":-9,"r":9,"s":0}', '{"q":-8,"r":9,"s":-1}','{"q":-7,"r":9,"s":-2}',
  '{"q":-6,"r":9,"s":-3}','{"q":-5,"r":9,"s":-4}', '{"q":-4,"r":9,"s":-5}','{"q":-3,"r":9,"s":-6}',
  '{"q":-2,"r":9,"s":-7}','{"q":-1,"r":9,"s":-8}', '{"q":0,"r":9,"s":-9}','{"q":1,"r":9,"s":-10}',
  '{"q":2,"r":9,"s":-11}','{"q":3,"r":9,"s":-12}', '{"q":4,"r":9,"s":-13}','{"q":5,"r":9,"s":-14}',
  '{"q":6,"r":9,"s":-15}', '{"q":7,"r":8,"s":-15}', '{"q":7,"r":7,"s":-14}', '{"q":8,"r":6,"s":-14}',
  '{"q":8,"r":5,"s":-13}', '{"q":9,"r":4,"s":-13}', '{"q":9,"r":3,"s":-12}', '{"q":10,"r":2,"s":-12}',
  '{"q":10,"r":1,"s":-11}', '{"q":11,"r":0,"s":-11}', '{"q":11,"r":-1,"s":-10}', '{"q":12,"r":-2,"s":-10}',
  '{"q":12,"r":-3,"s":-9}', '{"q":13,"r":-4,"s":-9}', '{"q":13,"r":-5,"s":-8}', '{"q":14,"r":-6,"s":-8}',
  '{"q":14,"r":-7,"s":-7}', '{"q":15,"r":-8,"s":-7}', '{"q":-2,"r":-8,"s":10}', '{"q":-3,"r":-7,"s":10}',
  '{"q":-4,"r":-6,"s":10}', '{"q":-5,"r":-5,"s":10}', '{"q":-6,"r":-4,"s":10}', '{"q":-7,"r":-4,"s":11}',
  '{"q":-6,"r":-2,"s":8}', '{"q":-6,"r":-1,"s":7}', '{"q":-6,"r":0,"s":6}', '{"q":-6,"r":1,"s":5}',
  '{"q":-2,"r":-2,"s":4}', '{"q":-2,"r":-1,"s":3}', '{"q":-4,"r":1,"s":3}', '{"q":-4,"r":2,"s":2}',
  '{"q":-5,"r":3,"s":2}', '{"q":-6,"r":4,"s":2}', '{"q":-7,"r":4,"s":3}', '{"q":-8,"r":4,"s":4}',
  '{"q":-9,"r":4,"s":5}', '{"q":-10,"r":4,"s":6}', '{"q":-11,"r":4,"s":7}', '{"q":-12,"r":4,"s":8}',
  '{"q":-5,"r":5,"s":0}', '{"q":-4,"r":4,"s":0}', '{"q":-3,"r":3,"s":0}', '{"q":-5,"r":6,"s":-1}',
  '{"q":-5,"r":7,"s":-2}', '{"q":-5,"r":8,"s":-3}', '{"q":3,"r":2,"s":-5}', '{"q":2,"r":3,"s":-5}',
  '{"q":1,"r":4,"s":-5}', '{"q":0,"r":5,"s":-5}', '{"q":-1,"r":6,"s":-5}', '{"q":-2,"r":7,"s":-5}',
  '{"q":4,"r":5,"s":-9}', '{"q":4,"r":6,"s":-10}', '{"q":5,"r":6,"s":-11}', '{"q":5,"r":7,"s":-12}',
  '{"q":7,"r":-2,"s":-5}', '{"q":8,"r":-2,"s":-6}', '{"q":9,"r":-3,"s":-6}', '{"q":10,"r":-3,"s":-7}',
  '{"q":4,"r":-4,"s":0}', '{"q":3,"r":-4,"s":1}', '{"q":2,"r":-4,"s":2}', '{"q":1,"r":-4,"s":3}',
  '{"q":2,"r":-5,"s":3}', '{"q":3,"r":-6,"s":3}', '{"q":4,"r":-7,"s":3}', '{"q":7,"r":2,"s":-9}',
  '{"q":4,"r":-1,"s":-3}', '{"q":4,"r":0,"s":-4}', '{"q":4,"r":1,"s":-5}', '{"q":4,"r":-2,"s":-2}'
];
...
export default class BFS extends React.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    if(nextState.cameFrom !== this.state.cameFrom) {
    	...
    	this.drawHex(this.canvasView, this.Point(x,y), 1, "black", "#42c0fb", 0.1);
 ...
 drawLine(canvasID, start, end, lineWidth, lineColor) {
   ...
   drawHexes() {
    ...
    this.setState(
    	...
    	this.shortestPathCallback = () => this.shortestPath(this.state.playerPosition))
   }
